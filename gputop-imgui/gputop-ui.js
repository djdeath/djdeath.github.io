...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'gputop-ui.wast';
  var wasmBinaryFile = 'gputop-ui.wasm';
  var asmjsCodeFile = 'gputop-ui.temp.asm.js';
...
var ASM_CONSTS = [function($0, $1) { var uriParams = new URLSearchParams(window.location.search); if (!uriParams.has('remoteHost')) return; var host = uriParams.get('remoteHost'); var numBytesWritten = stringToUTF8(host, $0, $1); },
 function() { var uriParams = new URLSearchParams(window.location.search); if (!uriParams.has('remotePort')) return 0; return parseInt(uriParams.get('remotePort')); },
 function($0) { var resizeFunc = function() { Module['_resize_window_callback'](window.innerWidth, window.innerHeight); }; window.addEventListener("resize", resizeFunc); resizeFunc(); },
 function($0, $1, $2) { if (Module['_gputop_websockets'] === undefined) { Module['_gputop_websockets'] = {}; Module['_gputop_websockets_id'] = 1; } var url = 'ws://' + Pointer_stringify($1) + ':' + $2 + '/gputop'; var ws = new WebSocket(url, 'binary'); console.log('Connecting to ' + url); ws.binaryType = 'arraybuffer'; var id = Module['_gputop_websockets_id']; Module['_gputop_websockets_id'] += 1; Module['_gputop_websockets'][id] = ws; ws.onopen = function() { Module['_gputop_emscripten_network_on_open']($0); }; ws.onclose = function(event) { console.log('close code='+ event.code + ' message=' + event.reason); Module['_gputop_emscripten_network_on_close']( $0, event.code, event.reason); }; ws.onmessage = function(event) { if (event.data instanceof ArrayBuffer) { ccall('gputop_emscripten_network_on_message', null, ['number', 'array', 'number'], [$0, new Uint8Array(event.data), event.data.byteLength]); } else console.error('Unable to handle WebSocket message', event.data); }; return id; },
 function($0, $1, $2) { var ws = Module['_gputop_websockets'][$0]; if (ws === undefined) return; var bytes = new Uint8Array(Module.HEAPU8.buffer, $1, $2); ws.send(bytes); },
 function($0) { var ws = Module['_gputop_websockets'][$0]; if (ws === undefined) return; ws.close(); },
...
STATICTOP = STATIC_BASE + 169888;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_gputop_ui_main_cpp() } }, { func: function() { __GLOBAL__sub_I_gputop_ui_utils_cpp() } }, { func: function() { __GLOBAL__sub_I_imgui_cpp() } });
...
function nullFunc_jiii(x) { Module["printErr"]("Invalid function pointer called with signature 'jiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  Module["printErr"]("Build with ASSERTIONS=2 for more info.");abort(x) }
...
Module['wasmTableSize'] = 13392;

Module['wasmMaxTableSize'] = 13392;
...
var real__gputop_cc_oa_accumulator_clear = asm["_gputop_cc_oa_accumulator_clear"]; asm["_gputop_cc_oa_accumulator_clear"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__gputop_cc_oa_accumulator_clear.apply(null, arguments);
};

var real__gputop_emscripten_network_on_close = asm["_gputop_emscripten_network_on_close"]; asm["_gputop_emscripten_network_on_close"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__gputop_emscripten_network_on_close.apply(null, arguments);
};

var real__gputop_emscripten_network_on_message = asm["_gputop_emscripten_network_on_message"]; asm["_gputop_emscripten_network_on_message"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__gputop_emscripten_network_on_message.apply(null, arguments);
};

var real__gputop_emscripten_network_on_open = asm["_gputop_emscripten_network_on_open"]; asm["_gputop_emscripten_network_on_open"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__gputop_emscripten_network_on_open.apply(null, arguments);
};
...
var real__resize_window_callback = asm["_resize_window_callback"]; asm["_resize_window_callback"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__resize_window_callback.apply(null, arguments);
};
...
Module["asm"] = asm;
var __GLOBAL__sub_I_gputop_ui_main_cpp = Module["__GLOBAL__sub_I_gputop_ui_main_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_gputop_ui_main_cpp"].apply(null, arguments) };
var __GLOBAL__sub_I_gputop_ui_utils_cpp = Module["__GLOBAL__sub_I_gputop_ui_utils_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_gputop_ui_utils_cpp"].apply(null, arguments) };
...
var _gputop_cc_oa_accumulator_clear = Module["_gputop_cc_oa_accumulator_clear"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_gputop_cc_oa_accumulator_clear"].apply(null, arguments) };
var _gputop_emscripten_network_on_close = Module["_gputop_emscripten_network_on_close"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_gputop_emscripten_network_on_close"].apply(null, arguments) };
var _gputop_emscripten_network_on_message = Module["_gputop_emscripten_network_on_message"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_gputop_emscripten_network_on_message"].apply(null, arguments) };
var _gputop_emscripten_network_on_open = Module["_gputop_emscripten_network_on_open"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_gputop_emscripten_network_on_open"].apply(null, arguments) };
...
var _resize_window_callback = Module["_resize_window_callback"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_resize_window_callback"].apply(null, arguments) };
